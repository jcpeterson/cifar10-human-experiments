...
class AdversarialAttack(object):
    ...
    def validation_loop(self, examples, labels, iter_no=None):
        ...
        elif isinstance(iter_no, str): # JOSH p2->p3 elif isinstance(iter_no, basestring):
            print_str += "(%s): " % iter_no
        else:
            pass
...
class PGD(AdversarialAttack):
    ...
    def attack(self, examples, labels, step_size=1.0/255.0,
        ...
        for iter_no in range(max_iterations): # JOSH py2->py3 for loss in self.losses.itervalues():
