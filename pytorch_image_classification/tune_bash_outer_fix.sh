...
models='pyramidnet_basic_110_270 shake_shake_26_2x64d_SSI_cutout16 wrn_28_10_cutout16 resnext_29_8x64d densenet_BC_100_12 wrn_28_10 resnet_preact_bottleneck_164 resnet_basic_110 vgg_15_BN_64' # no commas!
#models='pyramidnet_basic_110_270 shake_shake_26_2x64d_SSI_cutout16 resnet_preact_bottleneck_164' # no commas!
...
#                echo $s
                ...
                sbatch --output=${logfile} --export=model=$model,identifier=${identifier},python_args="${python_args}",logfile=${logfile} tune_bash_inner_fix.sh
                done
            done
